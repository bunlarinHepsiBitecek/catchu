...
class UserProfileViewControllerOld: UIViewController {
...
extension UserProfileViewControllerOld {
...
extension UserProfileViewControllerOld : UIGestureRecognizerDelegate {
    
    func addGestureRecognizersToTopBarItems() {
        
        let tapGestureRecognizerLeftBarItem = UITapGestureRecognizer(target: self, action: #selector(UserProfileViewControllerOld.leftBarItemPressed(_:)))
        tapGestureRecognizerLeftBarItem.delegate = self
        leftItem.addGestureRecognizer(tapGestureRecognizerLeftBarItem)
        
        let tapGestureRecognizerRigthBarItem = UITapGestureRecognizer(target: self, action: #selector(UserProfileViewControllerOld.rightBarItemPressed(_:)))
    ...
    func addSwipeGestureRecognizer() {
        ...
        let swipeGesture = UISwipeGestureRecognizer(target: self, action: #selector(UserProfileViewControllerOld.swipeToClose(_:)))
...
extension UserProfileViewControllerOld : NavigationControllerProtocols {
...
extension UserProfileViewControllerOld : ViewPresentationProtocols {
...
extension UserProfileViewControllerOld : UserProfileViewProtocols {
