...
@objcMembers
public class REFollowInfo : AWSModel {
    
    var error: REError?
    var userId: String?
    var resultArray: [REFollowInfo_resultArray_item]?
	...
	class func resultArrayJSONTransformer() -> ValueTransformer{
		return  ValueTransformer.awsmtl_JSONArrayTransformer(withModelClass: REFollowInfo_resultArray_item.self);
	}
}
