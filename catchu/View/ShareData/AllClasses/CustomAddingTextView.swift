...
//        NotificationCenter.default.addObserver(self, selector: #selector(CustomAddingTextView.keyboardWillShow(notification:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
...
//        NotificationCenter.default.addObserver(self, selector: #selector(CustomAddingTextView.keyboardWillHide(notification:)), name: NSNotification.Name.UIKeyboardWillHide, object: nil)
