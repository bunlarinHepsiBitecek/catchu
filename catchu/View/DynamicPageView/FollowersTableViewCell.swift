...
class FollowersTableViewCell: CommonFollowTableViewCell, CommonDesignableCell {
    ...
    override func deleteButtonTapped(_ sender: UIButton) {
        print("\(#function)")
        AlertControllerManager.shared.startActionSheetManager(type: .removeFollower, operationType: nil, delegate: self, title: "KOKO", image: nil)
    }
...
//        }
    ...
    func listenButtonOperations(completion: @escaping (_ buttonProcessData: FollowerCellButtonProcessData) -> Void) {
