...
class FollowingsTableViewCell: CommonFollowTableViewCell, CommonDesignableCell {
    
    private var followingsTableCellViewModel : FollowingsTableCellViewModel!
...
extension FollowingsTableViewCell {
    ...
    func initiateCellDesign(item: CommonViewModelItem?) {
        ...
        if let userViewModel = item as? CommonUserViewModel {
            ...
            followingsTableCellViewModel = FollowingsTableCellViewModel(commonUserViewModel: userViewModel)
            ...
            guard let commonUserViewModel = followingsTableCellViewModel.commonUserViewModel else { return }
