//
//  SettingsSlideMenuTableViewCell.swift
//  catchu
//
...
class SettingsSlideMenuTableViewCell: CommonSlideMenuTableCell, CommonDesignableCellForSlideMenu {
    
    var settingsSlideMenuTableCellViewModel: SettingsSlideMenuTableCellViewModel?
...
extension SettingsSlideMenuTableViewCell {
    ...
    func initiateCellDesign(item: CommonSlideMenuTableCellViewModelItem?) {
        ...
        guard let model = item as? SettingsSlideMenuTableCellViewModel else { return }
        
        self.settingsSlideMenuTableCellViewModel = model
        
        guard let settingsSlideMenuTableCellViewModel = settingsSlideMenuTableCellViewModel else { return }
        
        slideMenuImageView.image = settingsSlideMenuTableCellViewModel.cellImage
        slideMenuLabel.text = settingsSlideMenuTableCellViewModel.cellTitle
