//
//  ExplorePeopleSlideMenuTableViewCell.swift
//  catchu
//
...
class ExplorePeopleSlideMenuTableViewCell: CommonSlideMenuTableCell, CommonDesignableCellForSlideMenu {
    
    var exploreViewSlideMenuTableCellViewModel: ExploreViewSlideMenuTableCellViewModel?
...
extension ExplorePeopleSlideMenuTableViewCell {
    ...
    func initiateCellDesign(item: CommonSlideMenuTableCellViewModelItem?) {
        ...
        guard let model = item as? ExploreViewSlideMenuTableCellViewModel else { return }
        
        self.exploreViewSlideMenuTableCellViewModel = model
        
        guard let exploreViewSlideMenuTableCellViewModel = exploreViewSlideMenuTableCellViewModel else { return }
        
        slideMenuImageView.image = exploreViewSlideMenuTableCellViewModel.cellImage
        slideMenuLabel.text = exploreViewSlideMenuTableCellViewModel.cellTitle
